...
> [!NOTE]
> Zentail will automatically mark the pricing data as updated when the sale ends
> so you do not _need_ to keep track of the end date, you should receive a notification
> in your polling process.
