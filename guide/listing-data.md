...
There is also `pivotAttributes`, `categoryId` and `productTypeId`
which will be provided based on how you provided them to us in the
[taxonomy ingestion](./taxonomy-ingestion.md).
